class Helpers {
    ...
    static toRoman(t) {
        if (t = parseInt(t, 10), t > 0 && 6e3 > t) {
            var e, r, n, s = ["", "M", "MM", "MMM", "MMMM", "MMMMM"], o = ["", "C", "CC", "CCC", "CD", "D", "DC", "DCC", "DCCC", "CM"], a = ["", "X", "XX", "XXX", "XL", "L", "LX", "LXX", "LXXX", "XC"], i = ["", "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX"], u = function (e) {
                return e = (t - t % e) / e
            };
    ...
    static doNothing(t, e) {
        return !empty(t) && isNumber(t) && parseInt(t) > 0 ? void setTimeout(doNothing(0, e), parseInt(t)) : isCallable(e) ? e() : "done"
    }

    static notEmptyAndCallable(t) {
        return !empty(t) && isCallable(t)
    }

    static when(t) {
        if (!notEmptyAndCallable(t))return !1;
